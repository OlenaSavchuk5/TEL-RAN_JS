...
// "proger ".repeat(3); // "proger proger proger "
...
// В торым параметром можно установить границу (по умолчанию — до конца строки).

// let str = "Методы строк - как извлечь подстроку".slice(-9,-6);
// console.log(str);
// "Методы строк - как извлечь подстроку".slice(16, 21);
