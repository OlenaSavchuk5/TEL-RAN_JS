...
let addThree = el => el + 3;

let addThreeEven = (num, index) => index % 2 === 0 ? num + 3 : num;

// let newArr = arr.map(addThree);
...
console.log(myMap(arr, addThreeEven));
...
// Задание: к каждому из имен добавить строку "Hello, {name}". 
 let arr2 = ["Ivan", "Andrey", "Arsen"];
// возратить каждое имя со строкой в консоль

arr2.forEach(name => console.log(`Hello, ${name}`));
...
// выполнения функции. Функция lib получает callback